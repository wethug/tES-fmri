...
y7 = [1.530, 1.496, 1.481, 1.465, 1.455, 1.473, 1.463, 1.451, 1.439, 1.387, 1.375, 1.353, 1.315]
...
plt.ylabel("电流/mA", font=label_font)
plt.ylim(0, 5.0)

plt.title('电流源负载特性')
legend_font = {'family': 'MicroSoft Yahei', 'size': 16}
plt.legend(handles=[l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13],
           labels=['0.1mA', '0.2mA', '0.5mA', '0.8mA', '1.0mA', '1.2mA', '1.5mA', '1.8mA', '2.0mA', '2.5mA', '3.0mA',
                   '3.5mA', '4.0mA'], ncol=2, prop=legend_font)
